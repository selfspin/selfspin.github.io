...
$$
\begin{align*}
\eta = \min \left\{\frac{1}{2L}, \frac{\mu}{2p}\right\}, \quad \vert S_1 \vert = \frac{\sigma^2}{\mu \epsilon},\quad \vert S_2 \vert  = \sqrt{\vert S_1 \vert}, \quad  p = \frac{1}{\vert S_2 \vert}, \quad K = \frac{4\Delta L}{\epsilon^2} 
\end{align*}
$$
