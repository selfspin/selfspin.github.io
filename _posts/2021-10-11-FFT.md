...
$$
c_n = \frac{1}{\Delta t} \int_{-\Delta \frac{t}{2}}^{{-\Delta \frac{t}{2}}} s_{\Delta t}(t) e^{\frac{-i 2 \pi n t}{\Delta t}} 
=\frac{1}{\Delta t} \int_{-\Delta \frac{t}{2}}^{{-\Delta \frac{t}{2}} \delta(t) e^{\frac{-i 2 \pi n t}{\Delta t}} 
=\frac{1}{\Delta t} 
$$
