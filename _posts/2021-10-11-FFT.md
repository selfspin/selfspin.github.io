...
&= \frac{1}{2 N +1 } \sum_{k = -N}^{N} \sum_{j=0}^{2N} e^{ ik x - ik x_j}  f(x_j) dt
 \text{ (Let } x_j = \frac{k2j \pi }{2N+1})) \\
...
\text{With }c_n &= \frac{1}{\Delta t} \int_{-\Delta t/2}^{{-\Delta t/2}} s_{\Delta t}(t) e^{\frac{-i 2 \pi n t}{\Delta t}} \\
