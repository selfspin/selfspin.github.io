...
$$
\begin{align}
\epsilon^T(I-P_3) \epsilon &= \epsilon^T(I- P_4) \epsilon + \epsilon^T(P_4 - P_3 )  \epsilon \\
&= \epsilon^T(I- P_4) \epsilon + \epsilon^T(P_1 - P_3 )  \epsilon +\epsilon^T(P_2 - P_3 )  \epsilon +\epsilon^T(P_4 - P_1 - P_2 +P_3 )  \epsilon \\
S_T &= S_e + S_{AB} \\
&= S_e +S_A' +S_B' +S_{AB}' \\
\end{align}
$$
...
\begin{align}
\epsilon^T(I-P_3) \epsilon &= \epsilon^T(I- P_4) \epsilon + \epsilon^T(P_4 - P_3 )  \epsilon \\
&= \epsilon^T(I- P_1 -P_2 +P_3) \epsilon + \epsilon^T(P_1 - P_3 )  \epsilon +\epsilon^T(P_2 - P_3 )  \epsilon  \\
S_T &= S_e +S_{AB} \\
&=S_e' +S_A' +S_B' 
\end{align}
$$
